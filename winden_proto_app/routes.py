...
from .views import index,cancel_day,activate_winde, \
        ...
        calendar_list,add_calendar_list, pilot_list, schlepps, help
...
def setup_routes(app):
    ...
    app.router.add_get('/pilot_list', pilot_list, name='pilot_list')
    app.router.add_post('/pilot_list',pilot_list, name='pilot_list')
    ...
    app.router.add_post('/piloten',piloten, name='piloten')
